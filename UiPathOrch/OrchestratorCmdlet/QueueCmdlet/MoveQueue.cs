...
[Cmdlet(VerbsCommon.Move, "OrchQueue", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.Medium)]
public class MoveQueueCmdlet : MoveOrchEntityCmdletBase<QueueDefinition>
{
    ...
    protected override string ErrorId => "MoveQueueError";
