...
public class GetAssetLinkCmdlet : GetOrchLinkCmdletBase<Asset>
{
    ...
    protected override string DefaultCsvName => "ExportedAssetLinks.csv";
    ...
    protected override EntityLink BuildLink(string srcPath, Asset entity, string linkFolderPath, long srcFolderId, long linkFolderId)
        => new()
        {
            Path = srcPath,
            Name = entity.Name,
