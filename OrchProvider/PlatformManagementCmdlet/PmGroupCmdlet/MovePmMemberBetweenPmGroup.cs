...
{
    [Cmdlet(VerbsCommon.Move, "OrchPmMemberBetweenPmGroup", SupportsShouldProcess = true)]
    class MovePmMemberBetweenPmGroupCommand : OrchestratorPSCmdlet
    {
        ...
        [ArgumentCompleter(typeof(PmGroupNameCompleter<Positional.SourceGroupName_UserName_DestinationGroupName>))]
        [SupportsWildcards]
