...
```
Remove-OrchFolderUser [[-UserName] <String[]>] [[-FullName] <String[]>] [-Path <String[]>] [-Recurse]
...
### -FullName
Specifies the FullName of the users to be unassigned.
...
### -UserName
Specifies the UserName of the users to be unassigned.
