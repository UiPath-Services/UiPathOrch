...
## DESCRIPTION
The MayHaveRobotSession property of the specified users will be set to False.
...
### -UserName
Specifies the UserName of the users whose attended automations are to be disabled.
