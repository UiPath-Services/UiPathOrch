...
The format of the importable CSV can be obtained using Get-OrchMachine -ExportCsv c:.
...
### -AutomationType
Specifies the AutomationType of the machines to be added.
Please specify one of the following: Any, Foreground, or Background.
...
### -TargetFramework
Specifies the TargetFramework of the machines to be added.
Please specify one of the following: Any, Windows, or Portable.
...
### -Type
Specifies the Type of the machines to be added.
Please specify one of the following: Template.
