...
If scope is Global, the default values will be the initial ones.
If scope is Robot, then the default values will be the actual values set globally.
e.g., Resolution width Assume it was set globally to 720.
Then within the config returned by this function, the default value for this setting will be 0 if the scope is Global and 720 if the scope is Robot.
