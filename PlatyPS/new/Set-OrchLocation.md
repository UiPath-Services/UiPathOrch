...
## DESCRIPTION
The Set-OrchLocation cmdlet changes the current location (working directory) to the directory where the UiPathOrch module is installed.
This allows for quick navigation to the module's files and resources.
...
When specified, moves to the directory where that module is installed.
