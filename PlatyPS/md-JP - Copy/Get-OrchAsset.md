...
### ExportCsvParameterSet
```
Get-OrchAsset [-Path <String[]>] [-Recurse] [-Depth <UInt32>] [-ExportCsv <String>] [-CsvEncoding <Encoding>]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### ExportCredentialCsvParameterSet
```
Get-OrchAsset [-Path <String[]>] [-Recurse] [-Depth <UInt32>] [-ExportCredentialCsv <String>]
...
主に呼び出すエンドポイント: GET /odata/Assets

必要なスコープ: OR.Assets または OR.Assets.Read
...
```yaml
Type: Encoding
Parameter Sets: ExportCsvParameterSet, ExportCredentialCsvParameterSet
Aliases:
...
```yaml
Type: String
Parameter Sets: ExportCredentialCsvParameterSet
Aliases:
...
```yaml
Type: String
Parameter Sets: ExportCsvParameterSet
Aliases:
