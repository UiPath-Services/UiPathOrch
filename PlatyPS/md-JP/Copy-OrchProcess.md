...
プライマリエンドポイント: GET /odata/Releases({key})/UiPath.Server.Configuration.OData.GetRelease, GET /odata/Processes/UiPath.Server.Configuration.OData.GetPackageEntryPoints(key='{key}'), POST /odata/Releases
