...
```
Remove-OrchTestSetSchedule [-Name] <String[]> [-Path <String[]>] [-Recurse] [-Depth <UInt32>]
...
プライマリ エンドポイント: GET /odata/TestSetSchedules, DELETE /odata/TestSetSchedules({testSetScheduleId})

OAuth 必要なスコープ: OR.TestSetSchedules

必要な権限: TestSetSchedules.Delete
