...
主に呼び出すエンドポイント: GET /odata/QueueItems?$filter=(QueueDefinitionId eq {queueId})&$expand=Robot,ReviewerUser&orderby=Id

OAuth に必要なスコープ:  OR.Queues or OR.Queues.Read

必要な権限: Queues.View and Transactions.View
