...
プライマリエンドポイント: GET /odata/LicensesNamedUser/UiPath.Server.Configuration.OData.GetLicensesNamedUser(robotType='{robotType}')
...
プライマリエンドポイント: GET /odata/LicensesNamedUser/UiPath.Server.Configuration.OData.GetLicensesNamedUser
