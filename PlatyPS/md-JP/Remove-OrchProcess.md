...
```
Remove-OrchProcess [-Name] <String[]> [-Path <String[]>] [-Recurse] [-Depth <UInt32>]
...
プライマリ エンドポイント: GET /odata/Releases, DELETE /odata/Processes('{processId}:{version}')

OAuth 必要なスコープ: OR.Execution

必要な権限: Processes.Delete
