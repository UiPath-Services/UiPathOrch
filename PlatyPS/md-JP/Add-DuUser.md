...
### Example 1
```powershell
PS Orch1Du:\DocumentProcessing> Add-DuUser User john.doe Validator
```
...
### Example 2
```powershell
PS C:\> Add-DuUser -Path Orch1Du:\InvoiceProcessing User jane.smith "Data Entry", Reviewer
```
...
### Example 3
```powershell
PS Orch1Du:\DocumentProcessing> Add-DuUser User admin.user, lead.user Administrator -WhatIf
```
...
### Example 5
```powershell
PS Orch1Du:\> Add-DuUser -Recurse User document.reviewer "Data Entry" -WhatIf
```
