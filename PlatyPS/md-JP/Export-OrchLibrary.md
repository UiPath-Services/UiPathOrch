...
プライマリエンドポイント: GET /odata/Libraries, GET /odata/Libraries/UiPath.Server.Configuration.OData.GetVersions, GET /odata/Libraries/UiPath.Server.Configuration.OData.DownloadPackage
