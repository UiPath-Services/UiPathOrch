...
```
Remove-OrchTestDataQueue [-Name] <String[]> [-Path <String[]>] [-Recurse] [-Depth <UInt32>]
...
プライマリ エンドポイント: GET /odata/TestDataQueues, DELETE /odata/TestDataQueues({testDataQueueId})

OAuth 必要なスコープ: OR.TestDataQueues

必要な権限: TestDataQueues.Delete
