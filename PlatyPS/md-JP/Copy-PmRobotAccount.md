...
## DESCRIPTION
Copy-PmRobotAccount コマンドレットは、UiPath Platform Management を使用してソース組織から宛先組織にPlatform Managementロボットアカウントをコピーします。このコマンドレットは、認証設定、権限、グループ関連付けを含むロボットアカウント構成のコピーを作成し、複数のUiPath組織間でのロボットアカウント管理を可能にします。
...
プライマリエンドポイント: POST /api/RobotAccount
