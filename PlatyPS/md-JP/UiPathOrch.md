...
Test Manager のプロジェクトの権限情報を取得します。
...
Test Manager のプロジェクトから、テストケースを取得します。

### [Get-TmTestSet](Get-TmTestSet.md)
Test Manager のプロジェクトから、テストセットを取得します。
...
ジョブ実行時に自動で撮影された画面写真を、ジョブから削除します。
