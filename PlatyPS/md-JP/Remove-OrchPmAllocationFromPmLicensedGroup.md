...
主に呼び出すエンドポイント: DELETE /api/license/accountant/UserLicense/group/{groupId}/user/{userId}
...
### UiPath.PowerShell.Entities.Member
