...
### -Last
Specifies the most recent period for retrieving sessions.
...
### -ReportingTimeAfter
Specifies the start date and time for the ReportingTime of the sessions to be retrieved.
...
### -ReportingTimeBefore
Specifies the end date and time for the ReportingTime of the sessions to be retrieved.
