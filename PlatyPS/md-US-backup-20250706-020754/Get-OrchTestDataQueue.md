...
```powershell
PS C:\> Get-OrchTestCaseExecution -Recurse | Select-Object -First 1 | ConvertTo-Json -Depth 5
```
...
```powershell
PS C:\> Get-OrchTestCaseExecution -Recurse | Where-Object {$_.Status -eq "Passed"} | Select-Object Id, EntryPointPath, StartTime, EndTime
```
