...
### Example 4
```powershell
PS Orch1:\> Get-OrchJob -State "Faulted" -First 5 | ForEach-Object { Open-OrchJob -Id $_.Id }
```
...
### Example 5
```powershell
PS Orch1:\MyWorkspace> Get-OrchJob -Last "1h" | Where-Object State -eq "Faulted" | ForEach-Object { Open-OrchJob -Id $_.Id }
```
