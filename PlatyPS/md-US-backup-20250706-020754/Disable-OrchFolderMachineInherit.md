...
Disables inheritance for the machine named "TestMachine" in the Development folder without changing the current location.
...
### System.String[]
FolderMachine names can be piped to this cmdlet.

## OUTPUTS

### None
This cmdlet does not produce any output. The API call returns no data. Use Get-OrchFolderMachine to verify the result.
