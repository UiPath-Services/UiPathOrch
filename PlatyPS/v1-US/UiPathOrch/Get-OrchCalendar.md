...
Specifies the encoding to use when writing the CSV file. If not specified, the default encoding is used. Tab completion dynamically suggests available encoding names.
