...
### Example 1
```powershell
PS Orch1:\Shared> Remove-PmLicensedGroup LicensedGroup1 -WhatIf
```

Performs a test removal of the Platform Management licensed group 'LicensedGroup1'. The -WhatIf parameter shows what would be removed without actually performing the deletion.
