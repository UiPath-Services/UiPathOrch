...
### System.String[]
API trigger names can be piped to this cmdlet.

### UiPath.PowerShell.Entities.ApiTrigger
API trigger objects from Get-OrchApiTrigger can be piped to this cmdlet. The Name property will be automatically mapped to the -Name parameter via ByPropertyName binding.
