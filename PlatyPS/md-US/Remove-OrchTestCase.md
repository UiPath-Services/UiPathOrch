...
## DESCRIPTION
Removes test cases from UiPath Orchestrator. Test cases define the individual test scenarios that validate automation workflows. Use this cmdlet to clean up unused or outdated test cases from your testing environment.
...
### Example 1
```powershell
PS Orch1:\Shared> Remove-OrchTestCase TestCase001 -WhatIf
```

Performs a test removal of the test case 'TestCase001'. The -WhatIf parameter shows what would be removed without actually performing the deletion.
