...
### -IsConsumed
Specifies how to reset the consumption state of the items. If not specified, it will be reset to not consumed.
...
### -Name
Specifies the Name of the test queues containing items whose consumption status is to be updated.
