...
```
Add-OrchPmGroup [-GroupName] <String[]> [[-ObjectType] <String[]>] [[-Name] <String[]>] [-Path <String[]>]
...
### -Name
Specifies the name of the users to add to the groups.
...
### -ObjectType
Specifies the ObjectType of the users to add to the groups.
