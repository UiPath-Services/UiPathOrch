...
Displays machines with the names specified assigned to the current folder and its subfolders. This is useful for identifying which folders contain machines with a specified names. You can specify multiple machine names, separated by commas, including wildcards. Machine names can be auto-completed with [Ctrl+Space] or [Tab].
...
Displays machines with the names specified assigned to the specified folders. You can specify multiple folders, separated by commas, including wildcards.
