...
Gets all assets recursively and displays the Path, Name, and Value properties. Note that Path is selected first to identify which folder each asset belongs to.
