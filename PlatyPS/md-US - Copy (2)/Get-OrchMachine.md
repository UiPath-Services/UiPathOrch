...
### UiPath.PowerShell.Entities.Machine
Returns machine objects with metadata including Id, Name, Type, Scope, license slot allocations (UnattendedSlots, NonProductionSlots, TestAutomationSlots), and other properties. When -ExpandRobotUser is used, includes detailed robot user assignments.
