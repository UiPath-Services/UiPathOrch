...
### System.String[]
Workspace names and tenant paths can be piped to this cmdlet.

## OUTPUTS

### UiPath.PowerShell.Entities.PersonalWorkspace
Returns personal workspace objects containing information about workspace ID, name, owner details, activity status, last login information, and exploring user IDs.
