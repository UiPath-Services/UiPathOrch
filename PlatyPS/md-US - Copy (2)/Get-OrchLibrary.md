...
Library objects can be piped to this cmdlet. The Id property will be automatically mapped to the -Id parameter via ByPropertyName binding.

## OUTPUTS

### UiPath.PowerShell.Entities.Library
Returns library objects with metadata including Id, Version, Published date, Description, Authors, Tags, and other properties.
