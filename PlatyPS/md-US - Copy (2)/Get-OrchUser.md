...
### UiPath.PowerShell.Entities.User
Returns user objects with metadata including Id, UserName, FullName, EmailAddress, Type, RolesList, and other properties. When -ExpandDetails is used, includes detailed notification preferences and session information.
