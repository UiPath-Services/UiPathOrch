...
### UiPath.PowerShell.Entities.Role
Returns role objects with metadata including Id, DisplayName, Type, IsStatic, IsEditable, and other properties.

### UiPath.PowerShell.Entities.OrchRolePermissionExpanded
When -ExpandPermission is used, returns expanded objects with detailed permission information for each role-permission combination.
