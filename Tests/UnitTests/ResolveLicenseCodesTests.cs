...
// Pins AddPmUserLicenseCmdlet.ResolveLicenseCodes — the pure -License
...
public class ResolveLicenseCodesTests
{
    ...
    {
        var got = AddPmUserLicenseCmdlet.ResolveLicenseCodes(Patterns("CTZDEVNU"));
    ...
    {
        var got = AddPmUserLicenseCmdlet.ResolveLicenseCodes(Patterns("Attended - Named User"));
    ...
    {
        var got = AddPmUserLicenseCmdlet.ResolveLicenseCodes(Patterns("Attended*"));
    ...
    {
        var got = AddPmUserLicenseCmdlet.ResolveLicenseCodes(
    ...
    {
        var got = AddPmUserLicenseCmdlet.ResolveLicenseCodes(Patterns("NoSuchBundle*"));
        Assert.NotNull(got);
        Assert.Empty(got);
    }
    ...
    {
        var got = AddPmUserLicenseCmdlet.ResolveLicenseCodes(null!);
        Assert.NotNull(got);
        Assert.Empty(got);
    }
}
