...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-OrchActionCatalog.md'
Locale: en-US
...
```
Copy-OrchActionCatalog [-Path <string>] [-LiteralPath <string>] [-Recurse] [-Depth <uint>] [-Name] <string[]>
