...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/New-PmGroup.md'
Locale: en-US
...
```
New-PmGroup [-Path <string[]>] [-LiteralPath <string[]>] [-GroupName] <string[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
