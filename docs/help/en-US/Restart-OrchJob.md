...
```
Restart-OrchJob [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Id] <long[]> [-Confirm]
...
```
Restart-OrchJob [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Confirm] [-Job <Job>]
 [-WhatIf] [<CommonParameters>]
```
