...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Clear-OrchInactiveSession.md'
Locale: en-US
...
```
Clear-OrchInactiveSession [[-Path] <string[]>] [-LiteralPath <string[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
