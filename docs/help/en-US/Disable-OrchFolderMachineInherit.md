...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Disable-OrchFolderMachineInherit.md'
Locale: en-US
...
```
Disable-OrchFolderMachineInherit [-Path <string[]>] [-LiteralPath <string[]>] [-Name] <string[]> [-Confirm]
