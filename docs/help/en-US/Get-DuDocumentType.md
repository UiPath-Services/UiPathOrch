...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-DuDocumentType.md'
Locale: en-US
...
```
Get-DuDocumentType [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [[-Name] <string[]>] [<CommonParameters>]
```
...
[Get-DuClassifier](https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-DuClassifier.md)
