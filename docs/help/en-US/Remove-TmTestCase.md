...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-TmTestCase.md'
Locale: en-US
...
```
Remove-TmTestCase [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Name] <string[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
