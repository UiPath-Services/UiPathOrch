...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchApiTrigger.md'
Locale: en-US
...
```
Get-OrchApiTrigger [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>]
