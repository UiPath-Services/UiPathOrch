...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchProcessRequirement.md'
Locale: en-US
...
```
Get-OrchProcessRequirement [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>]
