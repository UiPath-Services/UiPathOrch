...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchFolderUser.md'
Locale: en-US
...
```
Get-OrchFolderUser [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [[-UserName] <string[]>]
