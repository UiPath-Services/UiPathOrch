...
```
Remove-OrchAssetLink [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Name] <string[]>
...
```powershell
PS C:\> Remove-OrchAssetLink -Path Orch1:\Depts\* -Depth 2 -Name SharedAsset -Link Orch1:\Common
```
