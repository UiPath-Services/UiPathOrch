...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-PmExternalApiResource.md'
Locale: en-US
...
```
Get-PmExternalApiResource [-Path <string[]>] [-LiteralPath <string[]>] [[-Name] <string[]>] [<CommonParameters>]
```
