...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Search-PmDirectory.md'
Locale: en-US
...
```
Search-PmDirectory [-Path <string[]>] [-LiteralPath <string[]>] [-Name] <string> [<CommonParameters>]
```
