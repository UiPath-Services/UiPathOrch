...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-OrchEventTrigger.md'
Locale: en-US
Module Name: UiPathOrch
ms.date: 03/06/2026
PlatyPS schema version: 2024-05-01
title: Remove-OrchEventTrigger
---
...
```
Remove-OrchEventTrigger [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Name] <string[]>
...
Removes event triggers with specified names from the target folders.
...
Primary Endpoint: DELETE /odata/ApiTriggers({triggerId})

OAuth required scopes: OR.Execution

Required permissions: EventTriggers.Delete
...
Removes the event trigger named 'MyEventTrigger' from the 'Shared' folder on Orch1.
...
Specifies the Name of the event triggers to be removed.
...
Main endpoint called: DELETE /odata/ApiTriggers({triggerId})
