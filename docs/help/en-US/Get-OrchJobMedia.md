...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchJobMedia.md'
Locale: en-US
...
```
Get-OrchJobMedia [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-First <ulong>]
