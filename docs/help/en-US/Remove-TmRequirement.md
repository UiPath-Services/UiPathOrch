...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-TmRequirement.md'
Locale: en-US
...
```
Remove-TmRequirement [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Name] <string[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
