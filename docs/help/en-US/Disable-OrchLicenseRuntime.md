...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Disable-OrchLicenseRuntime.md'
Locale: en-US
...
```
Disable-OrchLicenseRuntime [-Path <string[]>] [-LiteralPath <string[]>] [-RobotType] <string[]> [-Key] <string[]>
