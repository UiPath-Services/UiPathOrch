...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Edit-OrchProcess.md'
Locale: en-US
...
```
Edit-OrchProcess [-Path <string[]>] [-LiteralPath <string[]>] [[-Name] <string[]>] [<CommonParameters>]
```
