...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-OrchRoleFromUser.md'
Locale: en-US
...
```
Remove-OrchRoleFromUser [-Path <string[]>] [-LiteralPath <string[]>] [[-UserName] <string[]>] [-Roles] <string[]>
