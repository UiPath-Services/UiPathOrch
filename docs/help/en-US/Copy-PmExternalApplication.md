...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-PmExternalApplication.md'
Locale: en-US
...
```
Copy-PmExternalApplication [-Path <string>] [-LiteralPath <string>] [[-Name] <string[]>] [-Destination] <string[]>
