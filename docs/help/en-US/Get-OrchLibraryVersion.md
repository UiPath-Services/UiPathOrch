...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchLibraryVersion.md'
Locale: en-US
...
```
Get-OrchLibraryVersion [-Path <string[]>] [-LiteralPath <string[]>] [[-Id] <string[]>] [[-Version] <string[]>]
