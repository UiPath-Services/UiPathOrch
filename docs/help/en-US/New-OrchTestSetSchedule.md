...
```
New-OrchTestSetSchedule [-Path <string[]>] [-LiteralPath <string[]>] [-Name] <string[]>
 [-Confirm] [-CronExpression <string>] [-Description <string>] [-Enabled <string>]
 -TestSetName <string> [-TimeZoneId <string>] [-WhatIf] [<CommonParameters>]
```
