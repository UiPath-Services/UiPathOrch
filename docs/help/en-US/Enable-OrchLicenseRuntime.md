...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Enable-OrchLicenseRuntime.md'
Locale: en-US
...
```
Enable-OrchLicenseRuntime [-Path <string[]>] [-LiteralPath <string[]>] [-RobotType] <string[]> [-Key] <string[]>
