...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Move-PmGroupMember.md'
Locale: en-US
...
```
Move-PmGroupMember [-Path <string[]>] [-LiteralPath <string[]>] [-GroupName] <string> [-UserName] <string[]>
