...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchUserSession.md'
Locale: en-US
...
```
Get-OrchUserSession [-Path <string[]>] [-LiteralPath <string[]>] [-First <ulong>] [-OrderBy <string[]>]
