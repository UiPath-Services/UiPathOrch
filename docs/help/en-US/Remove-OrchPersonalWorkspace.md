...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-OrchPersonalWorkspace.md'
Locale: en-US
...
```
Remove-OrchPersonalWorkspace [-Path <string[]>] [-LiteralPath <string[]>] [[-Name] <string[]>]
