...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-PmGroup.md'
Locale: en-US
...
```
Remove-PmGroup [-Path <string[]>] [-LiteralPath <string[]>] [-GroupName] <string[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
