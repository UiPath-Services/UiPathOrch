...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Set-OrchSetting.md'
Locale: en-US
...
```
Set-OrchSetting [-Path <string[]>] [-LiteralPath <string[]>] [-Name] <string> [-Value] <string> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
