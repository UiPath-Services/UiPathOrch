...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchPersonalWorkspace.md'
Locale: en-US
...
```
Get-OrchPersonalWorkspace [-Path <string[]>] [-LiteralPath <string[]>] [[-Name] <string[]>] [<CommonParameters>]
```
