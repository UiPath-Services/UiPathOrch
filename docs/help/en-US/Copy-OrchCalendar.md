...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-OrchCalendar.md'
Locale: en-US
...
```
Copy-OrchCalendar [-Path <string>] [-LiteralPath <string>] [-Name] <string[]> [-Destination] <string[]> [-Confirm]
