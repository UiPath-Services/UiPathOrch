...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchLogLocation.md'
Locale: en-US
...
```
Get-OrchLogLocation [[-Path] <string>] [-LiteralPath <string>] [<CommonParameters>]
```
