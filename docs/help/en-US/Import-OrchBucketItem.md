...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Import-OrchBucketItem.md'
Locale: en-US
...
```
Import-OrchBucketItem [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Source] <string[]>
