...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchLicenseNamedUser.md'
Locale: en-US
...
```
Get-OrchLicenseNamedUser [-Path <string[]>] [-LiteralPath <string[]>] [[-RobotType] <string[]>] [<CommonParameters>]
```
