...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-OrchWebhook.md'
Locale: en-US
...
```
Remove-OrchWebhook [-Path <string[]>] [-LiteralPath <string[]>] [-Name] <string[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
