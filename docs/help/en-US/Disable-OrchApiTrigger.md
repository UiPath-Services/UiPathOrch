...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Disable-OrchApiTrigger.md'
Locale: en-US
Module Name: UiPathOrch
ms.date: 03/06/2026
PlatyPS schema version: 2024-05-01
title: Disable-OrchApiTrigger
---
...
```
Disable-OrchApiTrigger [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Name] <string[]>
...
Disables API triggers that are currently enabled, with specified names in the target folders.
...
Only API triggers that are currently enabled will be processed by this cmdlet.
...
The -Name parameter tab-completes only enabled API triggers.
...
Disables all enabled API triggers in the current folder and all its subfolders.
...
Tab completion lists only enabled API triggers.
