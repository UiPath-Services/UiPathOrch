...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-PmRobotAccount.md'
Locale: en-US
...
```
Copy-PmRobotAccount [-Path <string>] [-LiteralPath <string>] [-Name] <string[]> [-Destination] <string[]>
