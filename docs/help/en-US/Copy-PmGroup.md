...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-PmGroup.md'
Locale: en-US
...
```
Copy-PmGroup [-Path <string>] [-LiteralPath <string>] [[-GroupName] <string[]>] [-Destination] <string[]>
