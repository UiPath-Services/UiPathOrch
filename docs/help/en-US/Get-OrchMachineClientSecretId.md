...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchMachineClientSecretId.md'
Locale: en-US
...
```
Get-OrchMachineClientSecretId [-Path <string[]>] [-LiteralPath <string[]>] [[-Name] <string[]>]
