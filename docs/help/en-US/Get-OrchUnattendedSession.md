...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchUnattendedSession.md'
Locale: en-US
...
```
Get-OrchUnattendedSession [-Path <string[]>] [-LiteralPath <string[]>] [[-Status] <string[]>] [<CommonParameters>]
```
