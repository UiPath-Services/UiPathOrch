...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchPackage.md'
Locale: en-US
...
```
Get-OrchPackage [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [[-Id] <string[]>] [<CommonParameters>]
```
