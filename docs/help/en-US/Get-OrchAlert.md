...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchAlert.md'
Locale: en-US
...
```
Get-OrchAlert [-Path <string[]>] [-LiteralPath <string[]>] [[-Last] <string>] [[-Severity] <string>]
