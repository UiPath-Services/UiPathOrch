...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-OrchPackage.md'
Locale: en-US
...
```
Copy-OrchPackage [-Path <string>] [-LiteralPath <string>] [-Recurse] [-Depth <uint>] [-Id] <string[]>
