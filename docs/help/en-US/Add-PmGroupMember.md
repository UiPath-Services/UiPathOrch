...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Add-PmGroupMember.md'
Locale: en-US
...
```
Add-PmGroupMember [-Path <string[]>] [-LiteralPath <string[]>] [-GroupName] <string[]> [[-Type] <string[]>]
