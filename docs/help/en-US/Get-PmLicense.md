...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-PmLicense.md'
Locale: en-US
...
```
Get-PmLicense [-Path <string[]>] [-LiteralPath <string[]>] [[-License] <string[]>] [[-Code] <string[]>]
