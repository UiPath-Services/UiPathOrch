...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Export-OrchJobMedia.md'
Locale: en-US
...
```
Export-OrchJobMedia [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [[-JobId] <long[]>]
