...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-OrchCredentialStore.md'
Locale: en-US
...
```
Copy-OrchCredentialStore [-Path <string>] [-LiteralPath <string>] [-Name] <string[]> [-Destination] <string[]>
