...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Enable-OrchEventTrigger.md'
Locale: en-US
Module Name: UiPathOrch
ms.date: 03/06/2026
PlatyPS schema version: 2024-05-01
title: Enable-OrchEventTrigger
---
...
```
Enable-OrchEventTrigger [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>] [-Name] <string[]>
...
Enables event triggers that are currently disabled, with specified names in the target folders.
...
Only event triggers that are currently disabled will be processed by this cmdlet.
...
The -Name parameter tab-completes only disabled event triggers.
...
Enables all disabled event triggers in the current folder and all its subfolders.
...
Specifies the Name of the event triggers to be enabled.
Tab completion lists only disabled event triggers.
