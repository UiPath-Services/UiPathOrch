...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-OrchFolderUser.md'
Locale: en-US
...
```
Remove-OrchFolderUser [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>]
