...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Enable-OrchTestSetSchedule.md'
Locale: en-US
...
```
Enable-OrchTestSetSchedule [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>]
