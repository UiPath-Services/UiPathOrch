...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchTestCaseAssertion.md'
Locale: en-US
...
```
Get-OrchTestCaseAssertion [-Path <string[]>] [-LiteralPath <string[]>] [[-TestSetExecutionName] <string>]
...
```
Get-OrchTestCaseAssertion [-Path <string[]>] [-LiteralPath <string[]>] [-Id] <long[]> [-ScreenshotPath <string>]
 [<CommonParameters>]
```
...
```
Get-OrchTestCaseAssertion [-Path <string[]>] [-LiteralPath <string[]>] -InputObject <Object>
 [-ScreenshotPath <string>] [<CommonParameters>]
```
