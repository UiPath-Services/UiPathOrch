...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-TmTestExecution.md'
Locale: en-US
...
```
Get-TmTestExecution [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [[-Name] <string[]>]
 [<CommonParameters>]
```
