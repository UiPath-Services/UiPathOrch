...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-OrchCalendar.md'
Locale: en-US
...
```
Remove-OrchCalendar [-Path <string[]>] [-LiteralPath <string[]>] [-Name] <string[]> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
