...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-OrchWebhook.md'
Locale: en-US
...
```
Copy-OrchWebhook [-Path <string>] [-LiteralPath <string>] [-Name] <string[]> [-Destination] <string[]> [-Confirm]
