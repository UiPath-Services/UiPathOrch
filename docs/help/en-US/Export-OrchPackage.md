...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Export-OrchPackage.md'
Locale: en-US
...
```
Export-OrchPackage [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Id] <string[]> [[-Version] <string[]>]
