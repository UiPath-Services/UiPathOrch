...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Get-OrchLicenseStats.md'
Locale: en-US
...
```
Get-OrchLicenseStats [-Path <string[]>] [-LiteralPath <string[]>] [[-Last] <string>] [<CommonParameters>]
```
