...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Copy-OrchAsset.md'
Locale: en-US
...
```
Copy-OrchAsset [-Path <string>] [-LiteralPath <string>] [-Recurse] [-Depth <uint>] [-Name] <string[]>
