...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Add-OrchRoleToFolderUser.md'
Locale: en-US
...
```
Add-OrchRoleToFolderUser [-Path <string[]>] [-LiteralPath <string[]>] [-Recurse] [-Depth <uint>]
