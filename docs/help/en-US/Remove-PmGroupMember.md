...
HelpUri: 'https://github.com/UiPath-Services/UiPathOrch/blob/master/docs/help/en-US/Remove-PmGroupMember.md'
Locale: en-US
...
```
Remove-PmGroupMember [-Path <string[]>] [-LiteralPath <string[]>] [-GroupName] <string[]> [-Type] <string[]>
